            ...
            <div class="mt-4 row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="p-0 login-wrap">
                        <h6 class="mb-4 text-center" style="color: #ffffff;">Silahkan Masukkan Email Anda Untuk
                            Melakukan Reset
                            Password</h6>
                        <form action="{{ route('reset.link') }}" class="signin-form" id="flogin" method="post"
